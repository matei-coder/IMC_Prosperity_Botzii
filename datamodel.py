"""Local shim of the Prosperity datamodel (no jsonpickle dep).

This file is ONLY used when running `trader.py` locally (e.g. for backtest).
Prosperity's runtime provides its own datamodel.py that shadows this one.
"""
...
class ConversionObservation:
    def __init__(self, bidPrice: float, askPrice: float, transportFees: float,
                 ...
                 sugarPrice: float = 0.0, sunlightIndex: float = 0.0):
